const rewrites: Record<string, string> = {
  ...
  '03_网络协议/05_IP/01_index.md': 'ip/home.md',
  '03_网络协议/05_IP/02_IPv4地址的结构.md': 'ip/ipv4_address.md',
  '03_网络协议/05_IP/03_有类编址.md': 'ip/classful.md',
  '03_网络协议/05_IP/04_无类编址.md': 'ip/classless.md',
