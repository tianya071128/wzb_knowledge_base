const rewrites: Record<string, string> = {
  ...
  '02_工程化/03_vite/01_HMR.md': 'vite/HMR.md',
  ...
  '03_网络协议/03_http2/08_h2_问题.md': 'h2/issue.md',
  ...
  '03_网络协议/05_IPV4/03_有类编址.md': 'ipv4/classful.md',
  '03_网络协议/05_IPV4/04_无类编址.md': 'ipv4/classless.md',
  '03_网络协议/05_IPV4/05_IP报文.md': 'ipv4/packet.md',
  '03_网络协议/05_IPV4/06_IP报文抓包.md': 'ipv4/packet_capture.md',
  '03_网络协议/05_IPV4/07_IP配套协议.md': 'ipv4/supporting_protocols.md',
  '03_网络协议/05_IPV4/08_DHCP协议.md': 'ipv4/dhcp.md',
  '03_网络协议/05_IPV4/09_DHCP报文详解.md': 'ipv4/dhcp_packet.md',
  '03_网络协议/05_IPV4/10_获取指定IP.md': 'ipv4/dhcp_specific_ip.md',
  '03_网络协议/05_IPV4/11_ARP协议.md': 'ipv4/arp.md',
  '03_网络协议/05_IPV4/12_ARP协议抓包.md': 'ipv4/arp_capture.md',
  '03_网络协议/05_IPV4/13_ICMP协议.md': 'ipv4/icmp.md',
  '03_网络协议/05_IPV4/14_ping.md': 'ipv4/ping.md',
  '03_网络协议/05_IPV4/15_路由.md': 'ipv4/routing.md',
  '03_网络协议/05_IPV4/16_路由选路.md': 'ipv4/route_selection.md',
  ...
  '04_更多/06_git/07_命令_add_添加到暂存区.md': 'git/git-add.md',
